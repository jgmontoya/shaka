...
description: Decomposes a problem to fundamentals, challenges assumptions, and rebuilds the solution from constraints. Use when the issue may be a symptom, analogy is misleading, or root-cause reasoning matters more than precedent.
key: firstprinciples
