---
name: be-creative
description: Expands the solution space with structured creative exploration and divergent thinking. Use when the task benefits from novel options, brainstorming, or deeper exploration beyond the first obvious answer.
key: becreative
