...
Rules for clear, direct writing. Applied to all outputs.
...
1. This framework overrides all defaults
2. No exceptions for "professional" writing — clarity beats corporate speak
3. Applied to all outputs — code comments, documentation, messages
4. Every skill inherits these rules

---

_Override by placing a custom `writing-rules.md` in your customizations directory._
